...
- It’s taking longer and longer to introduce changes due to complexity (code, systems), lack of automated tests, manual tasks, etc.
- Usually, you need weeks to start satisfying a user's need. Your learning loops take weeks instead of hours or days.
- The bugs in Production keep growing and consuming time.
- Developers struggle to run production code and tests locally—let alone deliver a single-line change to users.
- Engineering efforts aren’t moving the needle or impacting business metrics as expected.

**For what position?** Well... it depends (sorry not sorry). Labels are too contextual and subjective and I don't care much about them; some might be "Senior/Staff Software Engineer", "Product Developer", "Hands-on Engineering Manager", "Enabler", "Product Engineering Coach", "Team Lead", or "Minion" (it really depends on the context and conditions).
...
- Some interesting people who have inspired me (random order): [Charity Majors](https://charity.wtf/), [Kent Beck](https://kentbeck.com/), [Martin Fowler](https://martinfowler.com/), [Liz Keogh](https://lizkeogh.com/), [Bob Marshall](https://flowchainsensei.wordpress.com/), [Eduardo Ferro](https://www.eferro.net/), [Marty Cagan](https://svpg.com/), [Jessica Kerr](https://jessitron.com/), [Uncle Bob](http://cleancoder.com/), [Woody Zuill](https://woodyzuill.com/), [Sandi Metz](https://sandimetz.com/), [Seth Godin](https://seths.blog/), [Sandro Mancuso](https://uk.linkedin.com/in/sandromancuso), [Donella H. Meadows](https://donellameadows.org/), [Carlos Blé](https://www.carlosble.com/), [Jez Humble](https://bsky.app/profile/jezhumble.net), [Melissa Perri](https://melissaperri.com/), [GeePaw Hill](https://www.geepawhill.org/), [Julia Evans](https://jvns.ca/), [Allen Hollub](https://holub.com/), [Sarah Mei](http://www.sarahmei.com/blog/about/), [Dave Farley](https://www.davefarley.net/), [Ron Jeffries](https://www.ronjeffries.com/), [Emily Bache](https://emilybache.com/), [Gojko Adzic](https://gojko.net/), [Xavi Gost](https://bsky.app/profile/xav1uzzz.bsky.social), [Taiichi Ohno](https://en.wikipedia.org/wiki/Taiichi_Ohno) and many others...
...
- You don't accept [a professional NO](https://www.thoughtfulleader.com/push-back-for-leaders/).
- There is no **SERIOUS psychological safety**: there are aggressive people who diminish other people opinions, either directly attacking them or putting them down (sometimes in "subtle" ways). People with lack of active listening (when you listen in order to understand the other person, to connect, not to answer or "defend yourself"), empathy, bad managament of the disagreement/conflict, etc. Extra red flags if the people doing it are the CxO/VP/HeadOf/EM/Lead, I've had enough of that 🙏
